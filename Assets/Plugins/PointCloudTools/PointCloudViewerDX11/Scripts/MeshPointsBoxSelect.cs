...
namespace mgear.tools
{
    public class MeshPointsBoxSelect : MonoBehaviour
    {
        ...
        public void Select(BoxCollider boxCollider)
        {
        ...
        bool PointInOABB(Vector3 worldPoint, Transform boxTransform, Vector3 boxCenterLocal, Vector3 boxSizeHalfLocal)
        {
